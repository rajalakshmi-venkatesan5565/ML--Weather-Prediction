...
## Algorithm
1.Open Jupyter Notebook on your computer. 2.Click New → Python 3 Notebook. 3.Type your Python code in a cell. 4.Press Shift + Enter to run the code.
...
## Output:
<img width="442" height="344" alt="image" src="https://github.com/user-attachments/assets/ebeb00c0-5a62-4bd5-af44-2a265a273edb" />
